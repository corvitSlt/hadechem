...
?>
<div class="order-receipt-index content">
		...
		<div class="card">
			<div class="card-header">
				...
				<div class="col-sm-6 c-flex">
					<span class="header-footer-btn">
						<?= Html::a('<span class="fas fa-plus-square btn-icon-span"></span>Tambah Penerimaan Barang', ['create'], ['class' => 'btn btn-primer']) ?>
					</span>
				</div>
				</div><!-- /.row -->
			</div>
			<div class="card-body">
				<?= GridView::widget([
								...
								'delete' => function ($url,$model) {
									return $model->flag && Yii::$app->user->identity->job->authorization->delete_employee
										...
										[
											...
											'data' => [
												'alertBox' => 'Apa anda yakin menonaktifkan SO?',
												'url' => $url,
										]]) : '';
								},
							],
					...
					'emptyText' => false,
					'tableOptions' =>['id' => 'dataTable-or', 'class' => 'table-th-search table table-striped table-bordered'],
				]); ?>
			</div>
		</div>
	</div>
