...
$this->title = 'Order Pembelian (PO)';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="purchase-order-index content">
		...
		<div class="card">
			<div class="card-header">
				...
				<div class="col-sm-6 c-flex">
					<span class="header-footer-btn">
						<?= Html::a('<span class="fas fa-plus-square btn-icon-span"></span>Tambah Order Pembelian', ['create'], ['class' => 'btn btn-primer']) ?>
					</span>
				</div>
				</div><!-- /.row -->
			</div>
			<div class="card-body">
				<?= GridView::widget([
					...
					'emptyText' => false,
					'tableOptions' =>['id' => 'dataTable-po', 'class' => 'table-th-search table table-striped table-bordered'],
				]); ?>
			</div>
		</div>
	</div>
