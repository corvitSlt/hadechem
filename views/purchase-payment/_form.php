...
<div class="purchase-payment-form  container-fluid trans-form transactions postloader close-load">
	<?php $form = ActiveForm::begin(); ?>
		<div class="card">
			...
			<div class="card-body trans-content trans-content-purchase-payment" <?php if($detail_purchasePayment) echo "data-detail-purchase-payment='".json_encode($detail_purchasePayment)."'";?>></div>
