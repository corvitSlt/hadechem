...
?>
<div class="purchase-payment-index content">
		...
		<div class="card">
			...
			<div class="card-body">
				<?= GridView::widget([
					...
					'emptyText' => false,
					'tableOptions' =>['id' => 'dataTable-purchasePayment', 'class' => 'table-th-search table table-striped table-bordered'],
				]); ?>
			</div>
		</div>
	</div>
