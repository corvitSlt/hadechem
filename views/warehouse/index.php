...
?>
<div class="warehouse-index content">
		...
		<div class="card">
			<div class="card-header">
				...
				<div class="col-sm-6 c-flex">
					<span class="header-footer-btn">
						<?= Html::a('<span class="fas fa-plus-square btn-icon-span"></span>Tambah Gudang', ['create'], ['class' => 'btn btn-primer']) ?>
					</span>
				</div>
				</div><!-- /.row -->
			</div>
			<div class="card-body">
				<?= GridView::widget([
						...
						[
							...
							'buttons' => [
								...
								'update' => function ($url,$model) {
									return $model->flag && Yii::$app->user->identity->job->authorization->update_warehouse
								...
								'delete' => function ($url,$model) {
									return $model->flag && Yii::$app->user->identity->job->authorization->delete_warehouse
										? Html::tag('button', '<span class="fas fa-times-square"></span>',
										[
											'class' =>'btn btn-primer submit-delete-table',
											'data' => [
												'alertBox' => 'Apa anda yakin menonaktifkan warehouse?',
												'url' => $url,
										]]) : '';
								},
							],
					...
					'emptyText' => false,
					'tableOptions' =>['id' => 'dataTable-warehouse', 'class' => 'table table-striped table-th-search table-bordered'],
				]); ?>
